...
import { africaCountries } from '@/services/resources/country/constants.ts'
...
const missingCount = computed(() => africaCountries.length - guessedCountries.value.guessed.length)
</script>

<template>
  <section>
    <h2 class="font-semibold text-xl">Africa</h2>
