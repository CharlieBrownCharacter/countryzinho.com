...
import { antarcticaCountries } from '@/services/resources/country/constants.ts'
...
const missingCount = computed(
  () => antarcticaCountries.length - guessedCountries.value.guessed.length,
)
</script>

<template>
  <section>
    <h2 class="font-semibold text-xl">Antarctica</h2>
