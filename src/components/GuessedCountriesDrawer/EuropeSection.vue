...
import { europeanCountries } from '@/services/resources/country/constants.ts'
...
const missingCount = computed(
  () => europeanCountries.length - guessedCountries.value.guessed.length,
)
</script>

<template>
  <section>
    <h2 class="font-semibold text-xl">Europe</h2>
