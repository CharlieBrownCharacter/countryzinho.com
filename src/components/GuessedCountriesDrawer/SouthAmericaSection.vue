...
import { southAmericaCountries } from '@/services/resources/country/constants.ts'
...
const missingCount = computed(
  () => southAmericaCountries.length - guessedCountries.value.guessed.length,
)
</script>

<template>
  <section>
    <h2 class="font-semibold text-xl">South America</h2>
